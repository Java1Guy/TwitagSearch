...
class Api(object):
  ...
  def Search(self, search, since_id=None, lang=None, perpage=None, page=None, geocode=None):
    url = 'http://search.twitter.com/search.json?show_user=true&q=%s' % search
    additional_args = {'since_id': since_id, 'lang' : lang, 'rpp' : perpage, 'page' : page, 'geocode' : geocode}
